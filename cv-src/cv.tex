...
{\color{muted} M.S. in Computer Science \& Artificial Intelligence \textbullet\ Dongguk University}\\[1pt]
...
% ======================= EDUCATION =======================
\section{Education}
\entry{Mar 2024 -- Aug 2026}{\textbf{M.S. in Computer Science and Artificial Intelligence} \\ Dongguk University, Seoul, Korea \\ {\color{muted}Major: AI in Healthcare and Medicine \textbullet\ GPA 4.04/4.5}}
\entry{Mar 2023 -- Feb 2024}{\textbf{B.S. in Industrial \& Management Engineering} (Advanced Major Program) \\ Induk University, Seoul, Korea \\ {\color{muted}Convergence Minor in Deep Learning \textbullet\ GPA 4.43/4.5 \textbullet\ Valedictorian}}
\entry{Mar 2020 -- Feb 2023}{\textbf{Associate of Engineering in Industrial \& Management Engineering} \\ Induk University, Seoul, Korea \\ {\color{muted}GPA 4.41/4.5 (Major 4.42/4.5) \textbullet\ Valedictorian}}

% ======================= RESEARCH EXPERIENCE =======================
\section{Research Experience}
\entry{Mar 2024 -- Present}{\textbf{Graduate Researcher}, PRISM Lab \\ Dongguk University, Seoul, Korea {\color{muted}(Advisor: \href{https://scholar.google.com/citations?user=d19A738AAAAJ}{Dr.\ Sangsoo Lim})}}
...
\entry{Jul 2025}{\textbf{Integrating Triple-View Chemical Graph Aggregation with Deep Topological Embedding for ADME Property Prediction} \\ {\color{muted}Poster, Korea Computer Congress (KCC) 2025, KIISE, Korea.}}
...
\entry{2025}{\textbf{Best Paper Award}, Undergraduate Paper Track --- KCC 2025 \\ {\color{muted}Korea Computer Congress (KCC), KIISE, Korea (MAGNET, co-author).}}
...
\entry{2025}{System and Method for Predicting Olfactory Characteristics of Odor Mixture Data \\ {\color{muted}Korean Patent Application (pending), No.\ 10-2025-0003146.}}
...
\skill{Programming}{Python, R, Java, C\#, JavaScript, SQL, HTML}
\skill{Deep Learning}{PyTorch, PyTorch Geometric, Hugging Face Transformers, scikit-learn, NumPy, Pandas}
